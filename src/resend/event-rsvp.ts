            ...
            <div style="padding: 40px 30px;">
              ...
              <div style="margin-bottom: 30px;">
                ...
                <p style="color: #4a5568; font-size: 16px; line-height: 1.7; margin: 0 0 20px 0;">
                  Thanks for RSVPing to <strong style="color: #ff4f00;">${eventTitle}</strong>! We're excited to have you join us.
                </p>
              </div>
              
              <!-- Event Details -->
              <div style="background: linear-gradient(135deg, #f7fafc 0%, #edf2f7 100%); border-radius: 12px; padding: 30px; margin-bottom: 40px; border-left: 4px solid #ff4f00;">
                <h2 style="color: #2d3748; margin: 0 0 20px 0; font-size: 20px;">Event Details</h2>
                
                <div style="margin-bottom: 15px;">
                  <p style="color: #4a5568; margin: 0 0 5px 0; font-size: 16px;">
                ...
                <a href="https://thebarefoot.dev/events/${eventSlug}" style="
              ...
              <div style="margin-bottom: 40px;">
                <div style="background: linear-gradient(135deg, #f7fafc 0%, #edf2f7 100%); border-radius: 12px; padding: 30px; margin-bottom: 20px; border-left: 4px solid #ff4f00;">
                  <h2 style="color: #2d3748; margin: 0 0 15px 0; font-size: 20px;">🛠️ Get Started Building</h2>
                  <p style="color: #4a5568; font-size: 14px; line-height: 1.6; margin: 0 0 15px 0;">
                    ...
                    <a href="https://www.thebarefoot.dev/blog/barefoot-dev-toolkit-find-the-right-tool-for-your-next-build" style="color: #ff4f00; text-decoration: none; font-weight: 500;">
                ...
                <div style="background: linear-gradient(135deg, #f7fafc 0%, #edf2f7 100%); border-radius: 12px; padding: 30px; border-left: 4px solid #ff4f00;">
                  <h2 style="color: #2d3748; margin: 0 0 15px 0; font-size: 20px;">🤝 Building Community Through Code</h2>
                  <p style="color: #4a5568; font-size: 14px; line-height: 1.6; margin: 0 0 15px 0;">
                    ...
                    <a href="https://www.thebarefoot.dev/blog/building-community-through-code-detroits-tech-renaissance" style="color: #ff4f00; text-decoration: none; font-weight: 500;">
              ...
              ${recentPosts.length > 0 ? `
                <!-- Recent Blog Posts -->
                <div style="margin-bottom: 40px;">
                  <h2 style="color: #2d3748; margin: 0 0 20px 0; font-size: 20px;">Recent Blog Posts</h2>
                  
                  ${recentPosts.map(post => `
                    <div style="margin-bottom: 20px; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; background-color: #f7fafc;">
                      <h3 style="color: #2d3748; font-size: 18px; margin: 0 0 10px 0;">
              ...
              <div style="background-color: #f7fafc; border-radius: 8px; padding: 20px; margin-bottom: 30px; border: 1px solid #e2e8f0;">
                <div style="display: flex; align-items: center; margin-bottom: 10px;">
                  ...
                  <strong style="color: #2d3748; font-size: 14px;">Quick Note</strong>
                </div>
